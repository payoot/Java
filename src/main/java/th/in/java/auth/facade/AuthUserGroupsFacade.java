...
import th.in.java.auth.entity.AuthUserGroups;
 ...
 */
public class AuthUserGroupsFacade extends AbstractFacade<AuthUserGroups> {
    ...
    public AuthUserGroupsFacade() {
        super(AuthUserGroups.class);
    }

    public AuthUserGroupsFacade(final EntityManager em) {
        super(AuthUserGroups.class);
